...
// Скачивание текущего списка как JSON-файла на компьютер пользователя.
// Это только чтение данных из памяти приложения — localStorage не трогается и не очищается.
